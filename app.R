####################################
# Gray Singh                       #
# http://github.com/graysinghlab   #
####################################

####################################
# Designed by Data Professor       #
# http://youtube.com/dataprofessor #
# http://github.com/dataprofessor  #
####################################

#Please note that errors returned for mismatch levels and
#randomforest have been corrected. 
...
ui <- fluidPage(theme = shinytheme("united"),
  ...
  # Page header
  headerPanel('A Day for Golfing Predictor'),
